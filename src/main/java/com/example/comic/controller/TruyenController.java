...
public class TruyenController {
    ...
    public List<Truyen> getTruyenURL() throws IOException {
        ...
        List<TheLoai> categoryListAll = theloaire.findAll();
        ...
        for (int i = 1; i < 2; i++) {
            ...
            Set<TheLoai> categoryList = new HashSet<>();
            ...
            for (Element comic : comics) {
                ...
                for (Element t_l : theloai) {
                    ...
                    TheLoai tl = categoryListAll
                            .stream()
                            .filter(x -> x.getTen_theloai().equals(t_l.attr("title")))
...
//                comicc.setLuotXem(Integer.parseInt(luotxem.text()));
                ...
                comicc.setTheloais(categoryList);
